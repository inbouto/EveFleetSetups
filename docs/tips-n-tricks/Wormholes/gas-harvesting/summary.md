...
:::note
Since ninja huffing and chameleon huffing don't require a specific ship or fit, and that Jedi huffing is the only technique that allows for the Minor reservoir's large cloud to be huffed, the [Jedi huffing-ready fit](./jedi-huffing#ships) is the one that will enable the most sites and clouds to be huffed.
:::
